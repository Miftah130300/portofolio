...
import OjiHero from '../asset/ojicrop2.png';
  ...
  return (
    <>
      ...
      {isMobile ? (
        ...
        <section className="min-h-screen flex items-center justify-center" id="landingpage">
          <div className="flex flex-col items-center mx-3">
            ...
            <div className="text-blue-950 text-[16px] sm:text-[18px] md:text-[18px] lg:text-[20px] xl:text-[16px] font-bold font-['Poppins'] my-5 text-center">
              A Front-End Developer. Experienced in designing and building User Interface.
            </div>
        ...
        // Desktop Version
        <section
          className="bg-center md:bg-cover min-h-screen flex items-center justify-center md:justify-center xl:justify-start"
          style={{ backgroundImage: `url(${OjiHero})` }}
          id="landingpage"
        >
          <div className="flex flex-col mx-6 items-center md:items-center xl:items-start">
            <div className="flex flex-col ">
              <div className="text-white text-[40px] lg:text-[50px] xl:text-[55px] font-bold font-['Poppins'] text-center xl:text-left">
                Miftah Fauzy
              </div>
              <div className="text-white text-[16px] font-bold font-['Poppins'] my-5 text-center xl:text-left">
                A Front-End Developer. Experienced in designing and building User Interface.
              </div>
            </div>
            <div className='flex justify-between w-full max-w-[250px]'>
              <button className="w-full max-w-[120px] h-11 bg-teal-400 hover:bg-teal-600 text-white rounded-[10px] text-[15px] font-bold font-['Mochiy Pop One'] mt-20" 
              onClick={onClick}>Let's connect</button>
              <button className="w-full max-w-[120px] h-11 bg-white hover:bg-teal-600 hover:text-white text-teal-400 rounded-[10px] text-[15px] font-bold font-['Mochiy Pop One'] mt-20" 
              ><a href={CVMiftah} download='cv_miftah-fauzy.pdf' target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()}>Download CV</a></button>
            </div>
          </div>
        </section>
