...
export function TechStack() {
  return (
    <section className="bg-white h-full w-full min-h-[852px] mb-10" id='techstack'>
      <div className="flex flex-col max-w-[350px] md:max-w-[600px] mt-[67px] justify-center mx-auto w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full h-full max-h-[800px] max-w-[500px] rounded-[20px] bg-white shadow-xl p-5 mt-[67px]">
          ...
          <div className='flex flex-col justify-center items-center'>
            <img className='m-5 h-full w-full max-w-[100px] max-h-[100px] p-3' src={nextjs} alt='nextjs logo'/>
            <label className='font-bold text-blue-950'>NextJs</label>
          </div>            
        </div>
      </div>
    </section>
