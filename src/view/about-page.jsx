...
export function AboutPage({onClick}) {
  return (
    <section className="bg-cover min-h-screen flex justify-center w-full" style={{ backgroundImage: `url(${aboutpage})` }} id='about'>
      <div className='flex flex-col w-full my-auto'>
        <h1 className='text-[20px] md:text-lg xl:text-xl 2xl:text-2xl text-white font-bold w-[100%] md:w-[90%] lg:w-[100%] xl:w-[100%] 2xl:w-[60%] bottom-[50%] p-3 text-center'>
